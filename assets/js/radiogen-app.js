...
class RadioGenApp extends GlobalRouting {
    constructor() {
        ...
        this._pageSwitcher.addPage('news-feeder',     Feeder.create('news',     'feeder-view'));
        this._pageSwitcher.addPage('podcast-feeder',  Feeder.create('podcast',  'feeder-view'));
        this._pageSwitcher.addPage('programs-feeder', Feeder.create('programs', 'feeder-view'));
        ...
        this._pageSwitcher.getPage('news-feeder').getRenderer().addView("feeds-view",         FeedNewsView);
        this._pageSwitcher.getPage('podcast-feeder').getRenderer().addView("feeds-view",      FeedPodcastView);
        this._pageSwitcher.getPage('programs-feeder').getRenderer().addView("feeds-view",   FeedProgramsView);
